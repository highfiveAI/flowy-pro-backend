...
Revision ID: 67a801745926
Revises: 3f294308915b
Create Date: 2025-06-02 16:39:31.583496
...
revision: str = '67a801745926'
down_revision: Union[str, None] = '3f294308915b'
...
def upgrade() -> None:
    ...
    sa.Column('user_company_id', sa.String(length=36), nullable=False),
    ...
    sa.Column('user_sysrole_id', sa.String(length=36), nullable=False),
