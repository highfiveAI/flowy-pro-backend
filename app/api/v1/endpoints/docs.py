...
from app.services.docs_recommend import run_doc_recommendation, recommend_docs_from_role
...
@router.post("/api/recommend", response_model=DocumentRecommendResponse)
